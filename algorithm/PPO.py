...
class PPO(AlgorithmInterface):
    ...
    def trainActionGrad(self, states, forwardDynamicsModel):
        ...
        next_state_grads = self.getGrads(next_states, alreadyNormed=True)[0] * 100.0
        # print ("next_state_grads shape: ", next_state_grads.shape)
        action_grads = forwardDynamicsModel.getGrads(states, actions, next_states, v_grad=next_state_grads, alreadyNormed=True)[0] * 100.0
