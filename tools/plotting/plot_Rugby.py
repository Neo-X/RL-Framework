...
if __name__ == '__main__':
    ...
    label='MAHRL(Hetero)'
    sns.lineplot(data=bf, x='Steps', y='Biped Falls', ax=ax3, label='MAHRL(PPO)',c=colors[label])
    ...
    # sns.lineplot(data=[], x=None, y=None, ax=ax3)
    label='PPO'
    sns.lineplot(data=bf, x='Steps', y='Biped Falls', ax=ax3, label='MAHRL(TD3)',c=colors[label])
    ...
    ax3.legend(h[:4],l[:4], bbox_to_anchor=(0.65, 0.8), loc=2)
