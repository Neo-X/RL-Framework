...
#    plt.figure(figsize=(15,8))
    ...
    label='MAHRL(Homo)'
    sns.lineplot(data=bf, x='Steps', y='Biped Falls', ax=ax3, label='MAHRL(Homo)', c=colors[label])
    ...
    bf = bf.rename(columns={1: 'Biped Falls', 0: 'Steps'})
    label='MAHRL(Hetero)'
    sns.lineplot(data=bf, x='Steps', y='Biped Falls', ax=ax3, label='MAHRL(Hetero)', c=colors[label] , ci =100)
    ax3.lines[-1].set_linestyle(linestyle[label])
