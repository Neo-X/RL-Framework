...
env = terrainRLSim.getEnv(env_name="PD_Humanoid_3D_WALK_Imitate_30FPS_v0", render=True)
...
states = []
time_limit=128
movie_writer = imageio.get_writer('movie.mp4', mode='I',  fps=30)
for i_episode in range(50):
    ...
    for t in range(time_limit):
        ...
        movie_writer.append_data(image_)
