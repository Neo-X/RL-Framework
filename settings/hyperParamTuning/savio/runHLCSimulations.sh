...
#	"settings/terrainRLMultiChar/HLC/CACLA/Concentric_Circles_SimpleReward_5_NEWLLC_Tensorflow_v4.json"
#	"settings/terrainRLMultiChar/HLC/CACLA/Concentric_Circles_SimpleReward_NEWLLC_Tensorflow_v4.json"
	"settings/terrainRLMultiChar/HLC/CACLA/Concentric_Circles_WithObs_SimpleReward_5_NEWLLC_Tensorflow_v0.json"
	"settings/terrainRLMultiChar/HLC/CACLA/Concentric_Circles_WithObs_SimpleReward_NEWLLC_Tensorflow_v0.json"
...
#	"settings/terrainRLMultiChar/HLC/PPO/Concentric_Circles_SimpleReward_NEWLLC_Tensorflow_v4.json"
#	"settings/terrainRLMultiChar/HLC/PPO/Concentric_Circles_SimpleReward_5_NEWLLC_Tensorflow_v4.json"
	"settings/terrainRLMultiChar/HLC/PPO/Concentric_Circles_WithObs_SimpleReward_5_NEWLLC_Tensorflow_v0.json"
	"settings/terrainRLMultiChar/HLC/PPO/Concentric_Circles_WithObs_SimpleReward_NEWLLC_Tensorflow_v0.json"
)
...
do
	...
	do
		...
		# echo "$simConfigFile"
		command="SINGULARITYENV_TERRAINRL_PATH=/opt/TerrainRL SINGULARITYENV_RLSIMENV_PATH=/opt/RLSimulationEnvironments sbatch --time=80:00:00 --mem=65536M --cpus-per-task=28 ./settings/hyperParamTuning/computeCanada/test_run.sh 'singularity exec --cleanenv --home /home/gberseth/projects/def-vandepan/gberseth/playground/RL-Framework:/opt/RL-Framework /scratch/gberseth/playground/singularity/ubuntu_learning.img python3.6 tuneHyperParameters.py --config="$simConfig" -p 5 --on_policy=fast --save_experience_memory=continual --num_rounds="$rounds" --continue_training=last --saving_update_freq_num_rounds=1 --plot=false --meta_sim_samples=3 --meta_sim_threads=3 --tuning_threads=2 --plotting_update_freq_num_rounds=5 --metaConfig="$metaExp" --email_log_data_periodically=true --shouldRender=false --max_epoch_length=128 --rollouts=8 "$opts"'"
		echo $command
		eval $command
	done
done
