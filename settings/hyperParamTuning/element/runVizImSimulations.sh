...
### Singe modal siamese networks
	"settings/terrainRLImitate3D/CACLA/MultiTask_Imitation_Learning_All8_128x128_1Sub_WithCamVel_Walk_30FPS_LSTM_FD_Reward_Encode.json"
	"settings/terrainRLImitate3D/CACLA/MultiTask_Imitation_Learning_DanceA_128x128_1Sub_WithCamVel_Walk_30FPS_LSTM_FD_Reward_Encode.json"
	"settings/terrainRLImitate3D/CACLA/MultiTask_Imitation_Learning_Jump_128x128_1Sub_WithCamVel_Walk_30FPS_LSTM_FD_Reward_Encode.json"
	"settings/terrainRLImitate3D/CACLA/MultiTask_Imitation_Learning_ZombieWalk_128x128_1Sub_WithCamVel_Walk_30FPS_LSTM_FD_Reward_Encode.json"

	"settings/terrainRLImitate3D/TRPO/MultiTask_Imitation_Learning_All8_128x128_1Sub_WithCamVel_Walk_30FPS_LSTM_FD_Reward_Encode.json"
	"settings/terrainRLImitate3D/TRPO/MultiTask_Imitation_Learning_DanceA_128x128_1Sub_WithCamVel_Walk_30FPS_LSTM_FD_Reward_Encode.json"
	"settings/terrainRLImitate3D/TRPO/MultiTask_Imitation_Learning_Jump_128x128_1Sub_WithCamVel_Walk_30FPS_LSTM_FD_Reward_Encode.json"
	"settings/terrainRLImitate3D/TRPO/MultiTask_Imitation_Learning_ZombieWalk_128x128_1Sub_WithCamVel_Walk_30FPS_LSTM_FD_Reward_Encode.json"
)
