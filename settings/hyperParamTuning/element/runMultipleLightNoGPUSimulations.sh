...
#	"settings/terrainRLImitate/TRPO/Imitation_Learning_GRF_1Sub_LSTM_FD_Reward_Dual_Encode_Decode_2State_2.json"
 	"settings/terrainRLImitate/TRPO/Imitation_Learning_GRF_1Sub_LSTM_FD_Reward_Dual_Encode_Decode_VAE_2State_2_Advisarial_BCE.json"
...
# 	"settings/terrainRLImitate/PPO/Imitation_Learning_GRF_1Sub_LSTM_FD_Reward_Dual_Encode_Decode_VAE_2State_2_Advisarial.json"
	...
	"settings/terrainRLImitate3D/TRPO/Imitation_Learning_GRF_Walk_1Sub_LSTM_FD_Reward_Dual_Encode_Decode_VAE_2State_2_BCE.json"
	"settings/terrainRLImitate3D/TRPO/Imitation_Learning_GRF_Run_1Sub_LSTM_FD_Reward_Dual_Encode_Decode_VAE_2State_2_BCE.json"
 	"settings/terrainRLImitate3D/TRPO/Imitation_Learning_GRF_ZombieWalk_1Sub_LSTM_FD_Reward_Dual_Encode_Decode_VAE_2State_2_BCE.json"
	"settings/terrainRLImitate3D/TRPO/Imitation_Learning_GRF_Jog_1Sub_LSTM_FD_Reward_Dual_Encode_Decode_VAE_2State_2_BCE.json"
	"settings/terrainRLImitate3D/TRPO/Imitation_Learning_GRF_Dance_A_1Sub_LSTM_FD_Reward_Dual_Encode_Decode_VAE_2State_2_BCE.json"
	"settings/terrainRLImitate3D/TRPO/Imitation_Learning_GRF_Dance_B_1Sub_LSTM_FD_Reward_Dual_Encode_Decode_VAE_2State_2_BCE.json"
	"settings/terrainRLImitate3D/TRPO/Imitation_Learning_GRF_Jump_1Sub_LSTM_FD_Reward_Dual_Encode_Decode_VAE_2State_2_BCE.json"
