...
# 	"settings/terrainRLImitate/TRPO/Treadmill_BayesianSurprise_IncludeStats_VAE_proper_v2.json"
#
...
rounds=500
# opts='--print_level=hyper_train --num_rounds=500 -p 8 --on_policy=fast --run_mode=ec2 --log_comet=true --bootstrap_sample=3 --meta_sim_sample=3 --random_seed=555 --meta_sim_threads=1 --experiment_logging="{\"use_comet\":true,\"project_name\":\"bayesiansurprise\"}"''
