...
opts='--print_level=hyper_train --num_rounds=2000 -p 8 --on_policy=fast --run_mode=ec2 --log_comet=true --bootstrap_sample=6 --meta_sim_sample=6 --random_seed=444 --meta_sim_threads=6 --experiment_logging="{\"use_comet\":true,\"project_name\":\"bayesiansurprise\"}"'
